...
<script>
import {create, index, remove, update, user_log} from '../../api/users_controller'
    ...
    save() {
      if (this.$refs.form.validate()) {
        ...
        if (this.editedIndex > -1) {
          ...
          update(this.editedItem).then(({ data: newItem }) => {
            this.$set(this.users, this.editedIndex, newItem)
